...
class JobOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     //var_dump($request->file('attach_academic_experience'));
        //     echo 'has attach_academic_experience';
        //     // $imgPath = $request->file('attach_academic_experience')->store('files', 'public');
        //     // echo $imgPath;


        //     $files = $request->file('attach_academic_experience');
        //     // var_dump($files);
        ...
        //     $attachFilesString = implode('|', $attachFiles);
            
        //     echo '<br>'. $attachFilesString;

        // }
        // else{
        //     echo 'no attach_academic_experience';
        // }
        // return;
        ...
        return redirect()->back()->with('success', 'JobOrder added successfully');
    }
